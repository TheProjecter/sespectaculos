   ...
   <?php if($totalRows_Listado==0 || $totalRows_Listado== null){  
    ...
    <tr class="colorFila" align="center">       
      <td><?php echo $row_Listado['NombreEspectaculo']; ?></td>
       <td><a href="modificarTipoEspectaculo.php?ID=<?php echo $row_Listado['idTipo']; ?>"><img src="./vistas/img/edit_f2.png" title="Modificar" border="0" align="absmiddle" alt="MODIFICAR"/></a></td> 
      <td><a href="index.php?controlador=opcionesAdministrador&opcion=borrar&eliminar=categorias&cod=<?php echo $row_Listado['idTipo']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><img src="./vistas/img/cancel_f2.png" title="ELIMINAR" border="0" align="absmiddle" alt="ELIMINAR"/></a></td>     
    </tr>
...
<table align="center" width="100%" class="bordeTablaGris">
    <tr valign="baseline">
      <td  align="right" class="letraLogin">Insertar Nuevo Espectaculo:</td>
      <td><input type="text" name="espectaculoNuevo"  value="" size="32" class="inputTexto"></input></td>
    </tr>
     </table>    
    <table align="center">
 		<tr valign="baseline">
