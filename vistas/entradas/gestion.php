...
<table align="center" width="100%" class="bordeTablaGris">
     <tr valign="baseline">
      <td style="text-decoration: blink"  align="center" class="letraLogin">Cargando Datos...</td>
      </tr>
     <tr align="center" valign="baseline">
     <td><input type="image"  align="center" src="./vistas/img/anim-loader.gif" height="40" width="160" value="" class="inputTexto"></input></td>
     </tr>
</table>
