 ...
 <table border="0" align="center" width="100%">
   ...
   <?php if($totalRows_Listado==0 || $totalRows_Listado== null){  
    ...
    <tr class="colorFila" align="center">       
      ...
      <td><?php echo $row_Listado['Hora']; ?></td>
	  <td><?php echo $row_Listado['estado']; ?></td>
      <td><a href="index.php?controlador=opcionesAdministrador&opcion=borrar&eliminar=solicitudes&cod=<?php echo $row_Listado['idOferta']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><img src="./vistas/img/cancel_f2.png" title="ELIMINAR" border="0" align="absmiddle" alt="ELIMINAR"/></a></td>     
    </tr>
