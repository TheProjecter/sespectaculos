...
<div><br></br><br></br></div>
		<div  style="float:left; margin-left:30%">
				<a href="index.php?controlador=opcionesUsuario&amp;opcion=comentarios" >
					<img src="./vistas/img/comments.png" height="80" width="80" alt="Listado de Anuncio" title="Listado de Anuncios"></img>					
					<br></br><span>Comentarios</span></a>

		</div>		
		<div  style="margin-left:60%">
				<a href="index.php?controlador=opcionesUsuario&amp;opcion=lusuarios" >
					<img src="./vistas/images/cuestionario.gif" height="80" width="80" alt="Nuevo Anuncio" title="Nuevo Anuncio"></img>					
					<br></br><span>Cuestionario</span></a>
